...
{
	[DataObject]
    public partial class UserWebFolderBLL
    {
        ...
        public bool UserWebFolderAdd(UserWebFolder userWebFolder)
        {
            return new UserWebFolderDAL().Add(userWebFolder);
        }
        #endregion
        ...
        {
            return new UserWebFolderDAL().DeleteByUserWebFolderID(userWebFolderID);
        }
        #endregion
		...
		{
			return new UserWebFolderDAL().GetBycolumnName(columnName,columnContent);
		}
        #endregion
        ...
        {
            return new UserWebFolderDAL().Update(userWebFolder);
        }
        #endregion
        ...
        {
            return new UserWebFolderDAL().GetByUserWebFolderID(userWebFolderID);
        }
        #endregion
		...
		{
			return new UserWebFolderDAL().GetTotalCount();
		}
		#endregion
		...
		{
			return new UserWebFolderDAL().GetPagedData(minrownum,maxrownum);
		}
		#endregion
		...
		{
			return new UserWebFolderDAL().GetAll();
		}
        #endregion
    }
}