...
namespace WebBookmarkService.DAL
{
	public partial class ConfigurationInfoDAL
	{
        ...
        public ConfigurationInfo GetByConfigurationKey(string configurationKey)
        {
            ...
            using (MySqlDataReader reader = MyDBHelper.ExecuteDataReader(sql, new MySqlParameter("@ConfigurationKey", configurationKey)))
            {
                if (reader.Read())
                {
                    return ToModel(reader);
        ...
        public IEnumerable<ConfigurationInfo> GetByConfigurationNo(int ConfigurationNo)
        {
            ...
            using (MySqlDataReader reader = MyDBHelper.ExecuteDataReader(sql, new MySqlParameter("@ConfigurationNo", ConfigurationNo)))
            {
                return ToModels(reader);
            }
        }
