...
namespace WebBookmarkService.DAL
{
	public partial class BookmarkCommentDAL
	{
        ...
        /// <summary>
        /// 获取BookmarkInfoID对应的评论信息
        /// </summary>
        /// <param name="bookmarkInfoID"></param>
        /// <returns></returns>
        public IEnumerable<BookmarkComment> GetByBookmarkInfoID(long bookmarkInfoID)
        {
            string sql = "SELECT * FROM tblBookmarkComment WHERE BookmarkInfoID = @BookmarkInfoID";
