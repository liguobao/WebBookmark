...
{
	[DataObject]
    public partial class UserRelationshipBLL
    {
        ...
        public bool UserRelationshipAdd(UserRelationship userRelationship)
        {
            return new UserRelationshipDAL().Add(userRelationship);
        }
        #endregion
        ...
        {
            return new UserRelationshipDAL().DeleteByUserRelationshipID(userRelationshipID);
        }
        #endregion
		...
		{
			return new UserRelationshipDAL().GetBycolumnName(columnName,columnContent);
		}
        #endregion
        ...
        {
            return new UserRelationshipDAL().Update(userRelationship);
        }
        #endregion
        ...
        {
            return new UserRelationshipDAL().GetByUserRelationshipID(userRelationshipID);
        }
        #endregion
		...
		{
			return new UserRelationshipDAL().GetTotalCount();
		}
		#endregion
		...
		{
			return new UserRelationshipDAL().GetPagedData(minrownum,maxrownum);
		}
		#endregion
		...
		{
			return new UserRelationshipDAL().GetAll();
		}
        #endregion
    }
}