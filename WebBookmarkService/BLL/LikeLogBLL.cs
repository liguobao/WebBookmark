...
{
	[DataObject]
    public partial class LikeLogBLL
    {
        ...
        {
            return new LikeLogDAL().DeleteByLikeLogID(likeLogID);
        }
        #endregion
		...
		{
			return new LikeLogDAL().GetBycolumnName(columnName,columnContent);
		}
        #endregion
        ...
        {
            return new LikeLogDAL().GetByLikeLogID(likeLogID);
        }
        #endregion
		...
		{
			return new LikeLogDAL().GetTotalCount();
		}
		#endregion
		...
		{
			return new LikeLogDAL().GetPagedData(minrownum,maxrownum);
		}
		#endregion
